...
Item {
    ...
    function activateMpvpaper() {
        console.log("mpvpaper", "Activating mpvpaper...");
    ...
    function deactivateMpvpaper() {
        console.log("mpvpaper", "Deactivating mpvpaper...");
    ...
    //         console.log("mpvpaper", "Turning mpvpaper on.");
    //
    //         activateMpvpaper();
    //
    //         thumbnails.startColorGen();
    //     } else if(!root.active) {
    //         console.log("mpvpaper", "Turning mpvpaper off.");
    //
    //         deactivateMpvpaper();
    //     }
    // }
    ...
    onCurrentWallpaperChanged: {
        console.log("mpvpaper", "Current wallpaper changed from mpvpaper");

        if (!root.active)
            return;

        if (root.currentWallpaper !== "") {
            console.log("mpvpaper", "Changing current wallpaper:", root.currentWallpaper);
            ...
            console.log("mpvpaper", "Current wallpaper is empty, turning mpvpaper off.");
    ...
    onHardwareAccelerationChanged: {
        console.log("mpvpaper", "Changing hardware acceleration");
    ...
    onIsMutedChanged: {
        if (!mpvProc.running) {
            console.log("mpvpaper", "No wallpaper is running!");
            return;
        }
    ...
    // onProfileChanged: {
    //     console.log("mpvpaper", "Changing current profile");
    //
    //     if (!root.active || !mpvProc.running) return;
    //
    ...
    //
    // onFillModeChanged:{
    //     console.log("mpvpaper", "Changing current fill mode");
    //
    //     if (!root.active || !mpvProc.running) return;
    //
    //     switch(fillMode){
